...
function SectionThree() {
    return(
        ...
        <ul className="icons">
					 ...
					 <li className="liIcons"><a target="_blanck_" href="https://drive.google.com/file/d/0B6-tH-LYKEJcdnBab3loVnl6MHJiNmNCb2JWUHVQdEliYWQ4/view?usp=sharing"><img className="logoInfo" src={Cv}  alt="Logo" /></a></li>
                     </ul>
    </section>
    );
};
